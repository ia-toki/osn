<div class="bp3-callout bp3-intent-warning">
	<p>Perbedaan dengan <a href="/OSN2018/peraturan">Peraturan OSN 2018</a> ditandai dengan <span style="color:red">warna merah</span>.</p>
</div>
...
<div class="bp3-card">
	...
	<ol>
		<li>OSN Informatika 2019 terdiri atas <strong>1 hari uji coba</strong> dan <strong>2 hari kompetisi</strong>.</li>
	...
	<ol>
		<li><span style="color:red"><del>Nilai peserta pada suatu soal merupakan <strong>nilai terbesar</strong> dari seluruh pengumpulan peserta pada soal tersebut</del></span>.</li>
		<li><span style="color:red">Pada soal bertipe <em>batch</em> dan <em>interactive</em>:</span>
			<ol>
				<li><span style="color:red">Pada penilaian kreatif, untuk setiap pengumpulan, nilai pada suatu subsoal adalah nilai minimum di antara seluruh kasus uji yang dicakup pada subsoal tersebut.</span></li>
				<li><span style="color:red">Nilai akhir pada suatu subsoal adalah <strong>nilai maksimum</strong> subsoal tersebut di antara seluruh pengumpulan.</span></li>
				<li><span style="color:red">Nilai peserta pada suatu soal merupakan jumlah nilai akhir seluruh subsoalnya.</span></li>
			</ol>

			<p><span style="color:red">Sebagai contoh, jika pengumpulan pertama mendapatkan nilai 30 pada subsoal pertama dan nilai 0 pada subsoal kedua, dan pengumpulan kedua mendapatkan nilai 0 pada subsoal pertama dan nilai 40 pada subsoal kedua, maka nilai peserta pada soal ini adalah 70.</span></p>
		</li>
		<li><span style="color:red">Pada soal bertipe <em>output-only</em></span>:
			<ol>
				<li><span style="color:red">Nilai akhir pada suatu kasus uji adalah <strong>nilai maksimum</strong> kasus uji tersebut di antara seluruh pengumpulan.</span></li>
				<li><span style="color:red">Nilai peserta pada suatu soal merupakan jumlah nilai akhir seluruh kasus ujinya.</span></li>
			</ol>
		</li>
	...
	<ol>
		<li>Peserta dapat mengajukan klarifikasi soal <span style="color:red"><del>dalam <strong>2 jam pertama</strong> setiap hari kompetisi</del> selama kompetisi berlangsung</span>.</li>
