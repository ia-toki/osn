...
class BaseController extends Controller
{
	...
	protected function getCompetitions($id, $level) {
		return $this->db->query(sprintf(<<<QUERY
			select c.ID as ID, Level, Year, c.Name as Name, p.ID as ProvinceID, p.Name as HostName, City, DateBegin, DateEnd, Contestants, Provinces, ScorePr, Finished from Competition c
