	...
	<ol>
		...
		<li><strong>Struktur Data</strong>
			<ul>
				...
				<li style="color:red"><em>Segment tree</em> (<em>point update range query</em>)</li>
			</ul>
		</li>
		...
		<li><strong>Geometri Dasar</strong>
			<ul>
				...
				<li style="color:red"><em>Convex Hull</em> (algoritma Graham scan, algoritma Monotone chain)</li>
			</ul>
		</li>
	</ol>
</div>
