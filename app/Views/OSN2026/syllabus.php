<div class="bp3-callout bp3-intent-warning">
  <p>Perbedaan dengan <a href="/OSN2025/silabus">Silabus OSN 2025</a> ditandai dengan <span style="color:red">warna merah</span>.</p>
</div>
...
<div class="bp3-card">
	...
	<hr>
    <h3>Materi</h3>
    <p>Mengacu pada <a href="https://ioinformatics.org/page/syllabus/12">silabus IOI 2026</a> dengan berbagai penyesuaian.</p>
    ...
    <ol>
        ...
        <li><strong>Strategi Pemecahan Masalah</strong>
            <ul>
                <li><s style="color: red"><em>Brute-force</em></s> <em>Complete search</em> (<em>brute-force</em> dan strategi <em>pruning</em>)</li>
                <li><em>Greedy</em></li>
                <li><em>Divide-and-conquer</em></li>
        ...
        <li><strong>Struktur Data</strong>
            <ul>
                ...
                <li><em>Point Update, Range Query</em> (misalnya menggunakan <em>Fenwick tree</em> atau <em>Segment tree</em>)</li>
            </ul>
        </li>
        <li><strong>Graf dan Tree</strong>
            <ul>
                ...
                <li><span style="color:red"><em>Lowest common ancestor</em> (LCA)</span></li>
            </ul>
        </li>
        <li><strong>Geometri Dasar</strong>
            <ul>
                ...
                <li>Definisi <em>Convex hull</em></li>
            </ul>
        </li>
    </ol>
</div>
