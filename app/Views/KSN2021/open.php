<div class="bp3-card">
    ...
    <ul>
    <li>
        <p>There are 3 possible problem types. Some problem type might not be tested.</p>
    </li>
    ...
    <li>
        <p>Creative problems will be stated explicitly in the problem description.</p>
    </li>
