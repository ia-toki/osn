...
class BaseController extends Controller
{
	...
	protected function getCompetitions($id, $level) {
		return $this->db->query(sprintf(<<<QUERY
			select c.ID as ID, Level, Year, c.Name as Name, p.ID as ProvinceID, p.Name as HostName, HostCountryCode, HostCountryName, City, DateBegin, DateEnd, Contestants, Provinces, ScorePr, Finished, DataComplete, Note from Competition c
