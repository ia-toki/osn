<div class="bp3-callout bp3-intent-warning">
    <p>Perbedaan dengan <a href="/OSN2019/peraturan">Peraturan OSN 2019</a> ditandai dengan <span style="color:red">warna merah</span>.</p>
</div>
...
<div class="bp3-card">
	...
	<ol>
		<li>KSN 2020 Bidang Informatika terdiri atas <strong>1 hari uji coba</strong> dan <strong>2 hari kompetisi</strong>.</li>
	...
	<ol>
		...
		<li>Pada soal bertipe <em>batch</em>:
			<ol>
				...
				<li>Contoh soal: <a href="https://tlx.toki.id/problems/osn-2018-1/C">Online Ojek, OSN 2018</a>.</li>
			</ol>
		</li>
		<li>Pada soal bertipe <em>interactive</em>:
			<ol>
				...
				<li>Program harus mengeluarkan jawaban dalam batas waktu dan memori yang dinyatakan pada soal.</li>
				<li>Contoh soal: <a href="https://tlx.toki.id/problems/osn-2019-2/B">Detecting Gold, OSN 2019</a>.</li>
			</ol>
		</li>
		<li>Pada soal bertipe <em>output-only</em>:
			<ol>
				...
				<li>Contoh soal: <a href="https://tlx.toki.id/problems/osn-2019-1/C">OSN Excursion, OSN 2019</a>.</li>
			</ol>
		</li>
	</ol>
	...
	<ol>
		...
		<li>Pada penilaian kreatif:
			<ol>
				...
				<li>Contoh soal:
					<ul>
						<li><em>Batch</em>: <a href="https://tlx.toki.id/problems/osn-2012-2/D">Membaca, OSN 2012</a>.</li>
						<li><em>Interactive</em>: <a href="https://tlx.toki.id/problems/osn-2014-1/B">Cat Rumah, OSN 2014</a>.</li>
						<li><em>Output-only</em>: <a href="https://tlx.toki.id/problems/osn-2016-2/C">Tourism in Palembang, OSN 2016</a>.</li>
					</ul>
				</li>
			</ol>
		</li>
	...
	<ol>
		<li>Peserta dapat mengajukan klarifikasi <span style="color:red"><del>soal</del></span> selama kompetisi berlangsung.</li>
		<li>Setiap klarifikasi <span style="color:red">yang berhubungan dengan soal</span> hanya akan dijawab dengan salah satu dari balasan berikut:
			<ul>
				<li>Ya</li>
				<li>Tidak</li>
...
<div class="bp3-card">
	...
	<ol>
		<li>Sebuah laptop (diutamakan) atau PC yang terkoneksi dengan internet untuk mengerjakan soal-soal kompetisi.</li>
		<li>Sebuah <em>smartphone</em> (diutamakan), laptop, atau webcam dan dilengkapi mikrofon yang terkoneksi dengan internet untuk merekam aktvitas peserta selama lomba dan terhubung ke Zoom.</li>
		<li>Kedua perangkat tersebut perlu dilengkapi dengan kuota internet sehingga mampu terhubung secara terus-menerus selama pelaksanaan kompetisi.</li>
		<li>Perangkat untuk Zoom adalah perangkat yang berbeda dengan perangkat untuk mengerjakan soal.</li>
	</ol>

	<hr />

	<h3 id="spesifikasi-grader">M. Spesifikasi <em>Grader</em></h3>
