<div class="bp3-callout bp3-intent-warning">
    <p>Perbedaan dengan <a href="/OSN2025/peraturan">Peraturan OSN 2025</a> ditandai dengan <span style="color:red">warna merah</span>.</p>
</div>
...
<div class="bp3-card">
    ...
    <ol>
    <li>OSN 2026 Bidang Informatika terdiri atas <strong>1 hari uji coba</strong> dan <strong>2 hari kompetisi</strong>.</li>
    ...
    <li>
    <div>Peserta-peserta yang memiliki total nilai yang sama akan diurutkan berdasarkan <b>penalti waktu</b>, yakni <b>jumlah</b> waktu (durasi) <b>pertama kali</b> tercapainya <b>nilai terakhir</b> pada <b>setiap harinya</b>.
    ...
    <li>Setiap klarifikasi yang berhubungan dengan soal hanya akan dijawab dengan salah satu dari balasan berikut:
        ...
        <li>"Ya"</li>
        <li>"Tidak"</li>
        <li>"Tidak ada komentar / jawaban terdapat pada deskripsi soal" <br />
...
<div class="bp3-card">
    ...
    <ul>
      <li><span style="color: red"><s>Google Chrome</s></span></li>
      <li><span style="color: red; font-weight: bold;">Firefox</span></li>
    </ul>
    ...
    <p><span style="color: red"><s><strong>Debugger</strong></s></span></p>
    <ul>
      <li><span style="color: red"><s>gdb</s></span></li>
    </ul>
